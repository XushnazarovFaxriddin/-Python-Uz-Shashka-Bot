...
bot = telebot.TeleBot('1722929735:AAG_gEoJ7DZZgoG8ISW3v2dkDdekdQ71BEA')
first = ""
second = ""
click = 'first'
whereboy = []
...
gamewithfriend = types.InlineKeyboardButton("Играть с другом", url='https://t.me/Uz_Shashka_Online', switch_inline_query_current_chat='@Uz_Shashka_Bot')
